        ...
        <form action="{{ route('settings.system.update') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <p class="text-muted small mb-2">
                    ...
                    @endif
                    <span class="ml-2 badge badge-secondary">source kode: {{ $effective['license_code_source'] }}</span>
                ...
                <div class="form-group form-check mb-2">
                    ...
                    <label for="license_required" class="form-check-label">Wajibkan lisensi untuk menggunakan sistem</label>
                </div>
                <div class="form-group">
                    <label>Kode Lisensi Owner (generated)</label>
                    <input type="text" class="form-control" value="{{ $effective['owner_license_code'] }}" readonly>
                ...
                <div class="form-group mb-3">
                    ...
                    <p class="text-muted small mb-1">
                        <span class="badge badge-secondary">source: {{ $effective['license_issuer_secret_source'] }}</span>
                    </p>
                    <input type="password" name="license_issuer_secret" class="form-control" value=""
                        autocomplete="off" placeholder="Isi secret issuer untuk generate/verifikasi token komersial">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="license_domain" class="form-control"
                                value="{{ old('license_domain', $values['license_domain']) }}" placeholder="domain.tld">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="license_plan" class="form-control"
                                value="{{ old('license_plan', $values['license_plan']) }}" placeholder="standard/pro">
                        </div>
                        <div class="form-group form-check mb-2">
                            <input type="checkbox" name="license_trial" id="license_trial" class="form-check-input"
                                value="1" {{ old('license_trial', $values['license_trial']) ? 'checked' : '' }}>
                            <label for="license_trial" class="form-check-label">Trial License</label>
                        </div>
                        <div class="form-group form-check mb-0">
                            <input type="checkbox" name="generate_commercial_license" id="generate_commercial_license"
                                class="form-check-input" value="1">
                            <label for="generate_commercial_license" class="form-check-label">Generate & set sebagai
                ...
                <div class="form-group mb-4">
                    ...
                    <p class="text-muted small mb-1">Effective Code: <strong>{{ $effective['license_code'] }}</strong></p>
                    <input type="text" name="license_code" class="form-control" value="{{ old('license_code') }}"
                        autocomplete="off" placeholder="MSI-XXXXXX-XXXXXX-XXXXXX-XXXXXX">
                    <div class="form-check mt-2">
                        <input type="checkbox" class="form-check-input" id="clear_license_code"
                            name="clear_license_code" value="1">
                        <label class="form-check-label" for="clear_license_code">Hapus lisensi aktif dari database</label>
                    </div>
                    <div class="form-check mt-2">
                        <input type="checkbox" class="form-check-input" id="revoke_active_license"
                            name="revoke_active_license" value="1">
                        <label class="form-check-label" for="revoke_active_license">Revoke lisensi aktif (khusus token
                            komersial)</label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <p class="text-muted small mb-1">
                        <span class="badge badge-secondary">source: {{ $effective['system_brand_name_source'] }}</span>
                    </p>
                ...
                <div class="form-group form-check mb-2">
                    <input type="checkbox" name="assistant_enabled" id="assistant_enabled" class="form-check-input"
                        value="1" {{ old('assistant_enabled', $values['assistant_enabled']) ? 'checked' : '' }}>
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="number" step="0.01" min="0" max="1" name="assistant_temperature"
                        class="form-control"
                ...
                <div class="form-group form-check mb-2">
                    <input type="checkbox" name="tracking_verification_enabled" id="tracking_verification_enabled"
                        class="form-check-input" value="1"
                        {{ old('tracking_verification_enabled', $values['tracking_verification_enabled']) ? 'checked' : '' }}>
                    <label for="tracking_verification_enabled" class="form-check-label">Aktifkan OTP verifikasi tracking
                        order publik</label>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <p class="text-muted small mb-1">
                        <span class="badge badge-secondary">source: {{ $effective['ipaymu_api_key_source'] }}</span>
                    </p>
                ...
                <div class="form-group">
                    ...
                    <p class="text-muted small mb-1">
                        <span class="badge badge-secondary">source: {{ $effective['ipaymu_base_url_source'] }}</span>
                    </p>
                    <input type="url" name="ipaymu_base_url" class="form-control"
                        value="{{ old('ipaymu_base_url', $values['ipaymu_base_url']) }}">
                </div>
                <div class="form-group form-check mb-3">
                    <input type="checkbox" name="ipaymu_verify_ssl" id="ipaymu_verify_ssl" class="form-check-input"
                        value="1" {{ old('ipaymu_verify_ssl', $values['ipaymu_verify_ssl']) ? 'checked' : '' }}>
                    <label for="ipaymu_verify_ssl" class="form-check-label">Verifikasi SSL iPaymu</label>
                    <span class="ml-2 badge badge-secondary">source: {{ $effective['ipaymu_verify_ssl_source'] }}</span>
                </div>
                <div class="form-group">
                    <label>RajaOngkir API Key</label>
                    <p class="text-muted small mb-1">
                        <span class="badge badge-secondary">source: {{ $effective['rajaongkir_key_source'] }}</span>
                    </p>
                ...
                <div class="form-group">
                    ...
                    <p class="text-muted small mb-1">
                        <span class="badge badge-secondary">source: {{ $effective['perpusnas_base_url_source'] }}</span>
                    </p>
                ...
                <div class="form-group">
                    ...
                    <p class="text-muted small mb-1">
                        <span class="badge badge-secondary">source: {{ $effective['perpusnas_token_source'] }}</span>
                    </p>
                ...
                <div class="form-group">
                    ...
                    <p class="text-muted small mb-1">
                        <span class="badge badge-secondary">source: {{ $effective['perpusnas_username_source'] }}</span>
                    </p>
                ...
                <div class="form-group">
                    ...
                    <p class="text-muted small mb-1">
                        <span class="badge badge-secondary">source: {{ $effective['perpusnas_password_source'] }}</span>
                    </p>
                ...
                <div class="form-group form-check mb-2">
                    ...
                    <label for="reminder_whatsapp_enabled" class="form-check-label">Enable Reminder WhatsApp</label>
                    <span class="ml-2 badge badge-secondary">source:
                ...
                <p class="text-muted small mb-2">
                    ...
                    <span class="ml-2 badge badge-secondary">source: {{ $effective['openrouter_api_key_source'] }}</span>
                </p>
                <div class="form-group">
                ...
                <p class="text-muted small mb-2">
                    ...
                    <span class="ml-2 badge badge-secondary">source: {{ $effective['openai_api_key_source'] }}</span>
                </p>
                <div class="form-group">
                ...
                <div class="form-group form-check">
                    <input type="checkbox" name="openai_verify_ssl" id="openai_verify_ssl" class="form-check-input"
                        value="1" {{ old('openai_verify_ssl', $values['openai_verify_ssl']) ? 'checked' : '' }}>
